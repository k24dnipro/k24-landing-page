...
export const metadata: Metadata = {
  ...
  keywords:
    "автосервіс Слобожанське, автосервіс Дніпро, СТО Слобожанське, ремонт авто, СТО, К24, ремонт двигуна, ремонт трансмісії, автодіагностика, рихтування, рихтовка, рихтування Дніпро, рихтовка Дніпро, полірування, полірування авто Дніпро, фарбування, фарбування авто Дніпро, кузовний ремонт, кузовний ремонт Дніпро",

  ...
  const galleryImages: GalleryImage[] = [
    {
      ...
      description: 'Повний капітальний ремонт двигуна з заміною поршневої групи та головки блоку циліндрів.'
    },
    {
      id: '2',
      ...
      beforeImage: '/placeholder-before.jpg',
      afterImage: '/placeholder-after.jpg',
      description: 'Повне фарбування кузова після ДТП з відновленням геометрії.'
    },
    {
      id: '3',
      ...
      beforeImage: '/placeholder-before.jpg',
      afterImage: '/placeholder-after.jpg',
      description: 'Повна реставрація шкіряних сидінь та оновлення панелі приладів.'
    },
    {
      id: '4',
      ...
      beforeImage: '/placeholder-before.jpg',
      afterImage: '/placeholder-after.jpg',
      description: 'Повна заміна передньої підвіски з амортизаторами та пружинами.'
    },
    {
      id: '5',
      ...
      beforeImage: '/placeholder-before.jpg',
      afterImage: '/placeholder-after.jpg',
      description: 'Діагностика та повний ремонт електричної системи автомобіля.'
    },
    {
      id: '6',
      ...
      beforeImage: '/placeholder-before.jpg',
      afterImage: '/placeholder-after.jpg',
      description: 'Форсування двигуна з установкою турбокомпресора та інтеркулера.'
    },
    {
      id: '7',
      ...
      beforeImage: '/placeholder-before.jpg',
      afterImage: '/placeholder-after.jpg',
      description: 'Повне відновлення автомобіля після потоплення з заміною всієї електроніки.'
    },
    {
      id: '8',
      ...
      beforeImage: '/placeholder-before.jpg',
      afterImage: '/placeholder-after.jpg',
      description: 'Зміна зовнішнього вигляду з установкою нового обвісу та оптики.'
    },
    {
      id: '9',
      ...
      beforeImage: '/placeholder-before.jpg',
      afterImage: '/placeholder-after.jpg',
      description: 'Установка спортивної підвіски з регульованими амортизаторами.'
    }
  ];
            ...
            <div className={styles.imageContainer}>
              <div className={styles.imageComparison}>
                ...
                <div 
                  ...
                  style={{
                    background: 'linear-gradient(135deg, #FFED00 0%, #FFF347 100%)',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    color: '#000',

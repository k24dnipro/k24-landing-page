  ...
  const services: Service[] = [
    {
      ...
      description:
        "Професійне фарбування автомобілів з використанням якісних фарб та сучасного обладнання. Повне або локальне фарбування.",
      icon: "🎨",
      features: [
    ...
    },
    {
      ...
      title: "Лакування",
      description:
        "Нанесення лаку для захисту та надання глибокого блиску фарбовому покриттю. Використання якісних матеріалів.",
      icon: "💎",
      features: [
